...
<form action="UserServlet?action=update" method="post" name="user" id="userForm">
<tr>
...
<td><div id="u126" class="ax_default text_field">
        <input id="u126_input" type="text" name="user_id" value="${user.user_id} " readonly="readonly"/>
      </div></td>
...
<td> <div id="u129" class="ax_default text_field">
        <input id="u129_input" type="text" name="user_name" value="${user.user_name}"/>
      </div></td>
...
<td><div id="u132" class="ax_default text_field">
        <input id="u132_input" type="password" name="user_password" value="${user.user_password}"/>
      </div></td>
...
<td><div id="u135" class="ax_default text_field">
        <input id="u135_input" type="text" name="user_dept" value="${user.user_dept }"/>
      </div></td>
<td></td>
</tr>
<tr>
...
<td><div id="u138" class="ax_default radio_button">
        ...
        <input id="u138_input" type="radio" value="radio" name="user_sex" <c:if test="${user_sex  eq '男' } ">   checked="checked"  </c:if>/>
      </div>
      <div id="u140" class="ax_default radio_button">
        ...
        <input id="u140_input" type="radio" value="radio" name="user_sex" <c:if test="${user_sex  eq '女' } ">   checked="checked"  </c:if> />
      </div></td>
<td></td>
</tr>
<tr>
...
<td><div id="u144" class="ax_default text_field">
        <input id="u144_input" type="text" name="user_job" value="${user.user_job}"/>
      </div></td>
<td></td>
</tr>
<tr>
...
<td><div id="u149" class="ax_default droplist">
        <select id="u149_input" name="user_type">
          <option value="普通用户" <c:if test="${user.user_type} eq '普通用户' ">   selected="selected"  </c:if> >普通用户</option>
          <option value="管理员" <c:if test="${user.user_type} eq '管理员' ">   selected="selected"  </c:if> >管理员</option>
        </select>
      </div></td>
<td></td>
</tr>
